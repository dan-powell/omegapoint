<header class="Header">
    ...
    <div class="HeaderControls">
        <button class="HeaderControls_button" onclick="window.human()"><span class="u-sronly">Human</span>
        ...
        <button class="HeaderControls_button" onclick="window.alien()"><span class="u-sronly">Alien</span>
        ...
        <button class="HeaderControls_button" onclick="window.robot()"><span class="u-sronly">Robot</span>
