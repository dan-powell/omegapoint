@persist('player')
    <header class="Header">
        <h1 class="HeaderLogo" id="js-logo">
            <a class="HeaderLogo-link" href="{{ route('news.index') }}" >
                O<span class="HeaderLogo-dynamic">mega</span> P<span class="HeaderLogo-dynamic">oint</span> N<span class="HeaderLogo-dynamic">ews</span>
            </a>
        </h1>
        <div class="HeaderControls">
            <button class="HeaderControls-button" onclick="window.human()"><span class="sronly">Human</span>
                <svg class="HeaderControls-button-icon" width="48px" height="48px" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <button class="HeaderControls-button" onclick="window.alien()"><span class="sronly">Alien</span>
                <svg class="HeaderControls-button-icon" width="48px" height="48px" viewBox="0 0 24 24" stroke-width="1.5" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <button class="HeaderControls-button" onclick="window.robot()"><span class="sronly">Robot</span>
                <svg class="HeaderControls-button-icon" width="48px" height="48px" viewBox="0 0 24 24" stroke-width="1.5" fill="none" xmlns="http://www.w3.org/2000/svg" color="#000000"><path d="M6.81815 22L6.81819 19.143C6.66235 17.592 5.63284 16.4165 4.68213 15M14.4545 22L14.4545 20.2858C19.3636 20.2858 18.8182 14.5717 18.8182 14.5717C18.8182 14.5717 21 14.5717 21 12.286L18.8182 8.8576C18.8182 4.28632 15.1094 2.04169 11.1818 2.00068C8.98139 1.97771 7.22477 2.53124 5.91201 3.5" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
