@persist('header')
    <header class="Header">
        <h1 class="Header-logo a-fadein" id="js-logo">
        ...
        <div class="Header-lang g-fadestagger" x-data="lang">
            ...
            <label class="Header-lang-label g-fade" for="language_human" tab-index="0">
                <svg class="Header-lang-label-icon" aria-hidden="true" focusable="false">
                    <use xlink:href="{{ asset('/news/spritesheet.svg#human') }}"></use>
                </svg>
            ...
            <label class="Header-lang-label g-fade" for="language_alien" tab-index="0">
                <svg class="Header-lang-label-icon" aria-hidden="true" focusable="false">
                    <use xlink:href="{{ asset('/news/spritesheet.svg#alien') }}"></use>
                </svg>
            ...
            <label class="Header-lang-label g-fade" for="language_robot" tab-index="0">
                <svg class="Header-lang-label-icon" aria-hidden="true" focusable="false">
                    <use xlink:href="{{ asset('/news/spritesheet.svg#robot') }}"></use>
                </svg>
